	...
	<div class="main-content">
		<div class="main-content-inner">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<form action="<c:url value="/admin-EditUserServlet2" />" method="post">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<button type="submit" class="btn btn-white btn-warning btn-bold">Cập nhật thông tin</button>
								</div>
							</div>
							<input type="hidden" value="${userFix.id}" name="id" />
